...
MEMORY
    {
    FLASH (rx) : ORIGIN = ((565248)), LENGTH = ((1486848) - 0x0)
    RAM (wx) : ORIGIN = (537133056), LENGTH = (258048)
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = (537133056) + (258048);
