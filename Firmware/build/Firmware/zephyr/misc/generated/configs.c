...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_EXPANSION_BOARD_HEADER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_USBHS_BC12_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_USBHS_WRAPPER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_VREGUSB_REGULATOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 290);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 1000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 2036);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 252);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_SRAM_SIZE, 0x7fe40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_HW_VERSION_LITE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_KMU_HW_PRESENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_MULTIPART_WORKAROUNDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_CTR_SIZE_WORKAROUNDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_IKG_INTERRUPT_WORKAROUND, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_MEMORY_ACCESS_WORKAROUND, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_LITE_ECC_COUNTERMEASURES_EXTENDED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_TFM_INTERNAL_TRUSTED_STORAGE, 0x4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_S_CODE_VECTOR_TABLE_SIZE, 0x4cc);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF54LM20DK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF54LM20DK_NRF54LM20A_CPUAPP_NS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF54LM20A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF54LM20A_CPUAPP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_COMPATIBLE_NRF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_COMPATIBLE_NRF54LX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_COMPATIBLE_NRF54LM20A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_COMPATIBLE_NRF54LM20A_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF54LM20A_DEVELOP_IN_NRF54LM20B, 1);
